...
<div class="family-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-family"
			  action="<?php echo Route::_('index.php?option=com_afarosadelsvents&task=familyform.save'); ?>"
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_afarosadelsvents&task=familyform.cancel'); ?>"
